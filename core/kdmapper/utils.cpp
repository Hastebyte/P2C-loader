...
bool utils::verify_hook( )
{
	//if ( !kernel_control_function( ) )
	//{
	//	MessageBox( HWND_DESKTOP, "Send developer this code: 001A", "Error", MB_OK );
	//	return false;
	//}

	//uint64_t result = call_driver_control( kernel_control_function( ), 7 );
